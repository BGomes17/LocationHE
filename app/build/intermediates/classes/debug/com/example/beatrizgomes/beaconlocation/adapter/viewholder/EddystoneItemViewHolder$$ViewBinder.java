...
public class EddystoneItemViewHolder$$ViewBinder<T extends com.example.beatrizgomes.beaconlocation.adapter.viewholder.EddystoneItemViewHolder> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131492982, "field 'instance'");
    target.instance = finder.castView(view, 2131492982, "field 'instance'");
    view = finder.findRequiredView(source, 2131492996, "field 'distance'");
    target.distance = finder.castView(view, 2131492996, "field 'distance'");
