...
public class BeaconsDetailsScan {
    ...
    public IEddystoneDevice eddystone;
    ...
    public BeaconsDetailsScan(Context context, String identifier) {
    ...
    private void onEddystoneDevicesList(final EddystoneDeviceEvent event) {
        ...
        for (IEddystoneDevice eddystoneDevice : eddystoneDevices) {
            ...
            if (context == EddystoneDetailsActivity.getContext()) {
                //Log.i("BeaconDetailsScan", "Details");
                ...
                double distance = eddystoneDevice.getDistance() / 100;
                Log.i("BeaconsDetailsScan", "Distance: " + distance);
